        ...
        <div className="w-full max-w-6xl mx-auto mt-8 p-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200">
                    <h2 className="text-2xl font-bold mb-4 text-brand-700">AI Analysis Report</h2>
                ...
                <div className="bg-white p-6 rounded-lg shadow-md border border-gray-200 flex flex-col justify-between">
                    ...
                    <div className="flex flex-col gap-3">
                        <a
                            ...
                            download
                            className="w-full py-4 bg-brand-600 hover:bg-brand-700 text-white text-center font-bold rounded-lg shadow transition-transform transform hover:scale-[1.02] flex items-center justify-center gap-2"
                        >
